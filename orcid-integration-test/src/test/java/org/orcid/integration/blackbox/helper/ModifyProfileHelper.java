...
public class ModifyProfileHelper {
    ...
    public String addWork(String userOrcid, String token) {
    ...
    public String addFunding(String userOrcid, String token) {
        String id = String.valueOf(System.currentTimeMillis());
        OrcidMessage orcidMessage = new OrcidMessage();
        orcidMessage.setMessageVersion(OrcidMessage.DEFAULT_VERSION);
        OrcidProfile orcidProfile = new OrcidProfile();
    ...
    public String addAffiliation(String userOrcid, String token) {
        String id = String.valueOf(System.currentTimeMillis());
        OrcidMessage orcidMessage = new OrcidMessage();
        orcidMessage.setMessageVersion(OrcidMessage.DEFAULT_VERSION);
        OrcidProfile orcidProfile = new OrcidProfile();
    ...
    public static String getBaseUrl() {
        return (String) context.getBean("webBaseUrl");
    }
}
